...
if [ ! "$qsqlite3Flag" ]; then
	...
	${CP} ${YEROTH_ERP_3_0_HOME_FOLDER}/yeroth-erp-3-0-deployment-configuration-scripts/yeroth-erp-3-0-system-local-configuration-ENGLISH.properties \
			"${OPT_INSTALLATION_TARGET_DIR}"
else
...
echo -e \"export YEROTH_ERP_3_0_SYSTEM_LOCAL_CONFIGURATION_PROPERTY_FILE=/opt/${YEROTH_ERP_3_0_BINARY_NAME}/yeroth-erp-3-0-system-local-configuration-ENGLISH.properties\" >> /etc/environment
chmod go+rw /opt/${YEROTH_SQL_BACKUP_FOLDER_NAME}
chmod go+rw /opt/${YEROTH_ERP_3_0_BINARY_NAME}/yeroth-erp-3-0-system-local-configuration-ENGLISH.properties"

...
bookmarks,
plainpages=false,
pdftitle={FACTURE CLIENT - YEROTHVENTECOMPTECLIENTREFERENCEINVOICEFACTURE pour le client YEROTHCLIENT, YEROTHENTREPRISE},
...
\section*{\underline{FACTURE}: YEROTHNUMEROFACTUREINVOICE}
\textbf{Heure de vente}: YEROTHHEUREVENTE\\
\textbf{TYPE DE VENTE}: YEROTHTYPEDEVENTE\\
\textbf{NOTRE RÉFÉRENCE}: YEROTHVENTECOMPTECLIENTREFERENCEINVOICEFACTURE\\
\textbf{Vendeur}: YEROTHVENDEUR\\
\textbf{SUCCURSALE D'ÉMISSION DE CETTE FACTURE}: YEROTHLOCALISATIONEMISSIONINVOICE
...
Total TTC 	 \\
 & & & & & & \\
\hline
YEROTHFACTUREINVOICEPRODUCTREFERENCE & 
YEROTHFACTUREINVOICEPRODUCTNAME 	 & 
YEROTHFACTUREINVOICECATEGORY 	 	 & 
YEROTHFACTUREINVOICESALEQUANTITY     & 
YEROTHFACTUREINVOICEUNITPRICE 	 	 &
YEROTHFACTUREINVOICETAX 		 	 & 
YEROTHFACTUREINVOICETOTALATC 		 \\ \hline
\multicolumn{2}{|c}{TOTAL} 	  		 & 
									 & 
YEROTHFACTUREINVOICESALEQUANTITY 	 & 
									 & 
YEROTHFACTUREINVOICETAX 		  	 & 
YEROTHFACTUREINVOICETOTALWITHCURRENCYATC 	\\ \hline 
\end{tabular}}
\end{table*}

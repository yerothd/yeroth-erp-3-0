...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Historique YEROTHHISTORYSTOCKASSET ''YEROTHSTOCKHISTORYDESIGNATION'' avec le ID: ''YEROTHSTOCKID'',
...
\section*{Historique YEROTHHISTORYSTOCKASSET ''YEROTHSTOCKHISTORYDESIGNATION'' avec le ID: ''YEROTHSTOCKID''}

...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={History of YEROTHHISTORYSTOCKASSET ''YEROTHSTOCKHISTORYDESIGNATION'' with ID: ''YEROTHSTOCKID'',
...
\section*{History of YEROTHHISTORYSTOCKASSET ''YEROTHSTOCKHISTORYDESIGNATION'' with ID: ''YEROTHSTOCKID''}

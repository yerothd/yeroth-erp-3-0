...
\begin{table}[!htbp]
\begin{tabular}{lrr}
%YEROTHFINANCIALACCOUNTONE  				&  YEROTHBILANCOMPTABLEEQUITYONE  					& [A1] \\ \hline
\textbf{Total financial account asset}  	&  YEROTHBILANCOMPTABLETOTALASSETBANQUEDEVISE &  \\	 
\end{tabular}
\end{table}
...
\textbf{ASSET}  				&  YEROTHBILANCOMPTABLEBALANCEDEVISE  & [TI -- TE]\\ \hline

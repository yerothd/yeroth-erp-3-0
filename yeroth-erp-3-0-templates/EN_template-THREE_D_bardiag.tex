...
\usepackage[YEROTHPAPERSPEC,nohead]{geometry}
...
\hypersetup{
    ...
    pdftitle={Diagram illustrating PURCHASE sales percentages
    		  per days of week from YEROTHCHIFFREAFFAIREDATEDEBUT
    		  to YEROTHCHIFFREAFFAIREDATEFIN YEROTHMENTION. (YEROTHFILTRE)},
...
\begin{figure}[!htbp]\centering
  ...
  \input{YEROTH-ERP-3D-BARDIAG-TEMPLATE.tex}
  \hspace{3em}

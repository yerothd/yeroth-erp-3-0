...
DISTDIR = /home/yerith/yeroth-erp-3-0/obj/yeroth-erp-3-01.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = src/yeroth-erp-3-0.cpp \
		...
		src/admin/modifier/yeroth-erp-admin-modifier-window.cpp moc/moc_YRruntimeverification_adaptor.cpp \
		moc/moc_IYRruntimeverificationAdaptor_interface.cpp \
		moc/moc_yeroth-erp-windows.cpp \
		moc/moc_yeroth-erp-marchandise-import.cpp \
		moc/moc_yeroth-erp-stock-import.cpp \
		moc/moc_yeroth-erp-table-view_WITH_TABWIDGET_AS_DIRECT_PARENT_movable_section.cpp \
		moc/moc_yeroth-erp-push-button-PASSWORD.cpp \
		moc/moc_yeroth-erp-progress-bar.cpp \
		moc/moc_yeroth-erp-admin-verif-logging-table-widget.cpp \
		moc/moc_yeroth-erp-creer-un-groupe-de-clients-table-widget.cpp \
		moc/moc_yeroth-erp-groupes-dun-client-table-widget.cpp \
		moc/moc_yeroth-erp-point-de-vente-table-widget.cpp \
		moc/moc_yeroth-erp-table-widget.cpp \
		moc/moc_yeroth-erp-table-view-with-pagination.cpp \
		moc/moc_yeroth-erp-table-view.cpp \
		moc/moc_yeroth-erp-comptes-doperations-comptabilite-table-view.cpp \
		...
		moc/moc_yeroth-erp-mouvements_de_stocks-table-view.cpp \
		moc/moc_yeroth-erp-GROUPES-DE-PAIE-HR-table-view.cpp \
		moc/moc_yeroth-erp-fournisseurs-table-view.cpp \
		moc/moc_yeroth-erp-programmes-de-fidelite-clients-table-view.cpp \
		moc/moc_yeroth-erp-groupes-de-clients-table-view.cpp \
		moc/moc_yeroth-erp-clients-table-view.cpp \
		moc/moc_yeroth-erp-alertes-table-view.cpp \
		moc/moc_yeroth-erp-CHARGES-FINANCIERES-table-view.cpp \
		moc/moc_yeroth-erp-achats-table-view.cpp \
		moc/moc_yeroth-erp-marchandises-table-view.cpp \
		moc/moc_yeroth-erp-line-edit.cpp \
		moc/moc_yeroth-erp-push-button.cpp \
		moc/moc_yeroth-erp-combo-box.cpp \
		moc/moc_yeroth-erp-datetime-edit.cpp \
		moc/moc_yeroth-erp-qcheckbox.cpp \
		moc/moc_yeroth-erp-select-db-qcheckbox.cpp \
		moc/moc_yeroth-erp-IMPRESSION_DE_DOCUMENT-dialog.cpp \
		moc/moc_yeroth-erp-dialog-commons.cpp \
		moc/moc_yeroth-erp-generic-select-db-field-dialog.cpp \
		...
		moc/moc_yeroth-erp-creer-groupe-de-clients-window.cpp \
		moc/moc_yeroth-erp-creer-un-programme-de-fidelite-clients-window.cpp \
		moc/moc_yeroth-erp-creer-compte-client-window.cpp \
		moc/moc_yeroth-erp-modifier-compte-client-window.cpp \
		moc/moc_yeroth-erp-details-dun-groupe-de-clients-window.cpp \
		moc/moc_yeroth-erp-clients-detail-window.cpp \
		moc/moc_yeroth-erp-details-dun-programme-de-fidelite-clients-window.cpp \
		moc/moc_yeroth-erp-programmes-de-fidelite-clients-window.cpp \
		moc/moc_yeroth-erp-groupes-de-clients-window.cpp \
		moc/moc_yeroth-erp-groupes-dun-client-window.cpp \
		moc/moc_yeroth-erp-clients-window.cpp \
		moc/moc_yeroth-erp-payer-compte-client-window.cpp \
		moc/moc_yeroth-erp-tableau-des-transactions-du-client-window.cpp \
		moc/moc_yeroth-erp-entrer-window.cpp \
		moc/moc_yeroth-erp-mouvements_de_stocks-window.cpp \
		...
		moc/moc_yeroth-erp-charges-financieres-window.cpp \
		moc/moc_yeroth-erp-charges-financieres-detail-window.cpp \
		...
		moc/moc_yeroth-erp-tableau-des-transactions-du-fournisseur-window.cpp \
		moc/moc_yeroth-erp-modifier-fournisseur-window.cpp \
		moc/moc_yeroth-erp-DETAILS-DUN-GROUPE-DE-PAIE-hr-window.cpp \
		moc/moc_yeroth-erp-DETAILS-DUN-GROUPE-DEMPLOYES-hr-window.cpp \
		moc/moc_yeroth-erp-GROUPES-dun-employe-hr-window.cpp \
		moc/moc_yeroth-erp-creer-GROUPE-DE-PAIE-hr-window.cpp \
		moc/moc_yeroth-erp-creer-groupe-DEMPLOYES-hr-window.cpp \
		moc/moc_yeroth-erp-GROUPES-DEMPLOYES-hr-window.cpp \
		moc/moc_yeroth-erp-GROUPES-DE-PAIE-hr-window.cpp \
		moc/moc_yeroth-erp-fournisseurs-window.cpp \
		moc/moc_yeroth-erp-creer-fournisseur-window.cpp \
		moc/moc_yeroth-erp-fournisseur-details-window.cpp \
		moc/moc_yeroth-erp-comptabilite-window.cpp \
		moc/moc_yeroth-erp-recherche-conditionnelle-window.cpp \
		...
		moc/moc_yeroth-erp-test-yeroth-erp-utils.cpp \
		moc/moc_yeroth-erp-test-yeroth-erp-table-view.cpp \
		moc/moc_yeroth-erp-test-yeroth-erp-windows.cpp \
		moc/moc_yeroth-erp-test-import-csv-file-data.cpp \
		moc/moc_yeroth-erp-test-utils.cpp \
		...
		moc/moc_yeroth-erp-spell-numbers.cpp \
		moc/moc_yeroth-erp-utils.cpp \
		moc/moc_yeroth-erp-print_yeroth_latex_util_pdf.cpp \
		...
		moc/moc_yeroth-erp-bank-account-table-view.cpp \
...
OBJECTS       = obj/yeroth-erp-3-0.o \
		obj/YRruntimeverification_adaptor.o \
		obj/IYRruntimeverificationAdaptor_interface.o \
		obj/yeroth-erp-windows.o \
		obj/yeroth-erp-marchandise-import.o \
		obj/yeroth-erp-stock-import.o \
		obj/yeroth-erp-table-view_WITH_TABWIDGET_AS_DIRECT_PARENT_movable_section.o \
		obj/yeroth-erp-push-button-PASSWORD.o \
		obj/yeroth-erp-progress-bar.o \
		obj/yeroth-erp-qcolumn-view.o \
		obj/yeroth-erp-table-view-with-pagination.o \
		obj/yeroth-erp-table-view.o \
		obj/yeroth-erp-comptes-doperations-comptabilite-table-view.o \
		obj/yeroth-erp-paiements-table-view.o \
		obj/yeroth-erp-stocks-table-view.o \
		obj/yeroth-erp-ventes-table-view.o \
		obj/yeroth-erp-mouvements_de_stocks-table-view.o \
		obj/yeroth-erp-GROUPES-DE-PAIE-HR-table-view.o \
		obj/yeroth-erp-fournisseurs-table-view.o \
		obj/yeroth-erp-groupes-de-clients-table-view.o \
		obj/yeroth-erp-clients-table-view.o \
		obj/yeroth-erp-alertes-table-view.o \
		obj/yeroth-erp-CHARGES-FINANCIERES-table-view.o \
		obj/yeroth-erp-achats-table-view.o \
		obj/yeroth-erp-marchandises-table-view.o \
		obj/yeroth-erp-programmes-de-fidelite-clients-table-view.o \
		obj/yeroth-erp-line-edit.o \
		obj/yeroth-erp-push-button.o \
		obj/yeroth-erp-text-edit.o \
		obj/yeroth-erp-combo-box.o \
		obj/yeroth-erp-radio-button.o \
		...
		obj/yeroth-erp-qcheckbox.o \
		obj/yeroth-erp-select-db-qcheckbox.o \
		obj/yeroth-erp-tab-widget.o \
		obj/yeroth-erp-admin-verif-logging-table-widget.o \
		obj/yeroth-erp-creer-un-groupe-de-clients-table-widget.o \
		obj/yeroth-erp-groupes-dun-client-table-widget.o \
		obj/yeroth-erp-point-de-vente-table-widget.o \
		obj/yeroth-erp-table-widget.o \
		obj/yeroth-erp-qtable-widget-item.o \
		obj/yeroth-erp-tab-widget.o \
		obj/yeroth-erp-process-info.o \
		obj/yeroth-erp-process.o \
		obj/yeroth-erp-IMPRESSION_DE_DOCUMENT-dialog.o \
		obj/yeroth-erp-dialog-commons.o \
		obj/yeroth-erp-generic-select-db-field-dialog.o \
		...
		obj/YEROTH_TABLEAUX_DE_BORDS_analyse_comparee_jour_semaine.o \
		obj/YEROTH_TABLEAUX_DE_BORDS_analyse_comparee_mensuelle.o \
		obj/yeroth-erp-comptabilite-window.o \
		obj/yeroth-erp-creer-groupe-de-clients-window.o \
		obj/yeroth-erp-creer-un-programme-de-fidelite-clients-window.o \
		obj/yeroth-erp-creer-compte-client-window.o \
		obj/yeroth-erp-details-dun-groupe-de-clients-window.o \
		obj/yeroth-erp-clients-detail-window.o \
		obj/yeroth-erp-details-dun-programme-de-fidelite-clients-window.o \
		obj/yeroth-erp-modifier-compte-client-window.o \
		obj/yeroth-erp-programmes-de-fidelite-clients-window.o \
		obj/yeroth-erp-groupes-de-clients-window.o \
		obj/yeroth-erp-groupes-dun-client-window.o \
		obj/yeroth-erp-clients-window.o \
		obj/yeroth-erp-payer-compte-client-window.o \
		obj/yeroth-erp-tableau-des-transactions-du-client-window.o \
		obj/yeroth-erp-entrer-window.o \
		obj/yeroth-erp-mouvements_de_stocks-window.o \
		...
		obj/yeroth-erp-charges-financieres-window.o \
		obj/yeroth-erp-charges-financieres-detail-window.o \
		...
		obj/yeroth-erp-tableau-des-transactions-du-fournisseur-window.o \
		obj/yeroth-erp-modifier-fournisseur-window.o \
		obj/yeroth-erp-DETAILS-DUN-GROUPE-DE-PAIE-hr-window.o \
		obj/yeroth-erp-DETAILS-DUN-GROUPE-DEMPLOYES-hr-window.o \
		obj/yeroth-erp-GROUPES-dun-employe-hr-window.o \
		obj/yeroth-erp-creer-GROUPE-DE-PAIE-hr-window.o \
		obj/yeroth-erp-creer-groupe-DEMPLOYES-hr-window.o \
		obj/yeroth-erp-GROUPES-DEMPLOYES-hr-window.o \
		obj/yeroth-erp-GROUPES-DE-PAIE-hr-window.o \
		obj/yeroth-erp-fournisseurs-window.o \
		obj/yeroth-erp-creer-fournisseur-window.o \
		obj/yeroth-erp-fournisseur-details-window.o \
		obj/yeroth-erp-recherche-conditionnelle-window.o \
		...
		obj/yeroth-erp-test-yeroth-erp-utils.o \
		obj/yeroth-erp-test-yeroth-erp-table-view.o \
		obj/yeroth-erp-test-yeroth-erp-windows.o \
		obj/yeroth-erp-test-import-csv-file-data.o \
		obj/yeroth-erp-test-utils.o \
		obj/yeroth-erp-user-settings.o \
		...
		obj/yeroth-erp-abstract-class-detail-view-window.o \
		obj/yeroth-erp-abstract-class-yerothsearch-window.o \
		obj/yeroth-erp-key-emitter.o \
		obj/yeroth-erp-spell-numbers.o \
		obj/yeroth-erp-sqltable-model.o \
		obj/yeroth-erp-LIST-map-COMPLEX-ITEM.o \
		obj/yeroth-erp-map-COMPLEX-ITEM.o \
		obj/yeroth-erp-payment-processing-information.o \
		...
		obj/yeroth-erp-print_yeroth_latex_util_pdf.o \
		...
		obj/yeroth-erp-bank-account-table-view.o \
		...
		obj/moc_yeroth-erp-windows.o \
		obj/moc_yeroth-erp-marchandise-import.o \
		obj/moc_yeroth-erp-stock-import.o \
		obj/moc_yeroth-erp-table-view_WITH_TABWIDGET_AS_DIRECT_PARENT_movable_section.o \
		obj/moc_yeroth-erp-push-button-PASSWORD.o \
		obj/moc_yeroth-erp-progress-bar.o \
		obj/moc_yeroth-erp-admin-verif-logging-table-widget.o \
		obj/moc_yeroth-erp-creer-un-groupe-de-clients-table-widget.o \
		obj/moc_yeroth-erp-groupes-dun-client-table-widget.o \
		obj/moc_yeroth-erp-point-de-vente-table-widget.o \
		obj/moc_yeroth-erp-table-widget.o \
		obj/moc_yeroth-erp-table-view-with-pagination.o \
		obj/moc_yeroth-erp-table-view.o \
		obj/moc_yeroth-erp-comptes-doperations-comptabilite-table-view.o \
		obj/moc_yeroth-erp-paiements-table-view.o \
		obj/moc_yeroth-erp-stocks-table-view.o \
		obj/moc_yeroth-erp-ventes-table-view.o \
		obj/moc_yeroth-erp-mouvements_de_stocks-table-view.o \
		obj/moc_yeroth-erp-GROUPES-DE-PAIE-HR-table-view.o \
		obj/moc_yeroth-erp-fournisseurs-table-view.o \
		obj/moc_yeroth-erp-programmes-de-fidelite-clients-table-view.o \
		obj/moc_yeroth-erp-groupes-de-clients-table-view.o \
		obj/moc_yeroth-erp-clients-table-view.o \
		obj/moc_yeroth-erp-alertes-table-view.o \
		obj/moc_yeroth-erp-CHARGES-FINANCIERES-table-view.o \
		obj/moc_yeroth-erp-achats-table-view.o \
		obj/moc_yeroth-erp-marchandises-table-view.o \
		obj/moc_yeroth-erp-line-edit.o \
		obj/moc_yeroth-erp-push-button.o \
		obj/moc_yeroth-erp-combo-box.o \
		obj/moc_yeroth-erp-datetime-edit.o \
		obj/moc_yeroth-erp-qcheckbox.o \
		obj/moc_yeroth-erp-select-db-qcheckbox.o \
		obj/moc_yeroth-erp-IMPRESSION_DE_DOCUMENT-dialog.o \
		obj/moc_yeroth-erp-dialog-commons.o \
		obj/moc_yeroth-erp-generic-select-db-field-dialog.o \
		...
		obj/moc_yeroth-erp-creer-groupe-de-clients-window.o \
		obj/moc_yeroth-erp-creer-un-programme-de-fidelite-clients-window.o \
		obj/moc_yeroth-erp-creer-compte-client-window.o \
		obj/moc_yeroth-erp-modifier-compte-client-window.o \
		obj/moc_yeroth-erp-details-dun-groupe-de-clients-window.o \
		obj/moc_yeroth-erp-clients-detail-window.o \
		obj/moc_yeroth-erp-details-dun-programme-de-fidelite-clients-window.o \
		obj/moc_yeroth-erp-programmes-de-fidelite-clients-window.o \
		obj/moc_yeroth-erp-groupes-de-clients-window.o \
		obj/moc_yeroth-erp-groupes-dun-client-window.o \
		obj/moc_yeroth-erp-clients-window.o \
		obj/moc_yeroth-erp-payer-compte-client-window.o \
		obj/moc_yeroth-erp-tableau-des-transactions-du-client-window.o \
		obj/moc_yeroth-erp-entrer-window.o \
		obj/moc_yeroth-erp-mouvements_de_stocks-window.o \
		...
		obj/moc_yeroth-erp-charges-financieres-window.o \
		obj/moc_yeroth-erp-charges-financieres-detail-window.o \
		...
		obj/moc_yeroth-erp-tableau-des-transactions-du-fournisseur-window.o \
		obj/moc_yeroth-erp-modifier-fournisseur-window.o \
		obj/moc_yeroth-erp-DETAILS-DUN-GROUPE-DE-PAIE-hr-window.o \
		obj/moc_yeroth-erp-DETAILS-DUN-GROUPE-DEMPLOYES-hr-window.o \
		obj/moc_yeroth-erp-GROUPES-dun-employe-hr-window.o \
		obj/moc_yeroth-erp-creer-GROUPE-DE-PAIE-hr-window.o \
		obj/moc_yeroth-erp-creer-groupe-DEMPLOYES-hr-window.o \
		obj/moc_yeroth-erp-GROUPES-DEMPLOYES-hr-window.o \
		obj/moc_yeroth-erp-GROUPES-DE-PAIE-hr-window.o \
		obj/moc_yeroth-erp-fournisseurs-window.o \
		obj/moc_yeroth-erp-creer-fournisseur-window.o \
		obj/moc_yeroth-erp-fournisseur-details-window.o \
		obj/moc_yeroth-erp-comptabilite-window.o \
		obj/moc_yeroth-erp-recherche-conditionnelle-window.o \
		...
		obj/moc_yeroth-erp-test-yeroth-erp-utils.o \
		obj/moc_yeroth-erp-test-yeroth-erp-table-view.o \
		obj/moc_yeroth-erp-test-yeroth-erp-windows.o \
		obj/moc_yeroth-erp-test-import-csv-file-data.o \
		obj/moc_yeroth-erp-test-utils.o \
		...
		obj/moc_yeroth-erp-spell-numbers.o \
		obj/moc_yeroth-erp-utils.o \
		obj/moc_yeroth-erp-print_yeroth_latex_util_pdf.o \
		...
		obj/moc_yeroth-erp-bank-account-table-view.o \
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		yeroth-erp-3-0.pro src/include/yeroth-erp-3-0-precompiled-header.hpp \
...
bin/yeroth-erp-3-0: ui_yeroth-erp-main-window.h ui_yeroth-erp-recherche-conditionnelle-window.h ui_yeroth-erp-imprimer-dialog.h ui_yeroth-erp-comptabilite-window.h ui_yeroth-erp-sortir-window.h ui_yeroth-erp-entrer-window.h ui_yeroth-erp-mouvements_de_stocks-window.h ui_yeroth-erp-marchandises-window.h ui_yeroth-erp-modifier-window.h ui_yeroth-erp-historique-du-stock-window.h ui_yeroth-erp-stocks-window.h ui_yeroth-erp-sortir-liststocks-window.h ui_yeroth-erp-stock-detail-window.h ui_yeroth-erp-pointdevente-liststocks-window.h ui_yeroth-erp-pointdevente-window.h ui_yeroth-erp-pointdevente-methode-paiement-carte-credit-dialog.h ui_yeroth-erp-pointdevente-methode-paiement-comptant-entree-dialog.h ui_yeroth-erp-pointdevente-methode-paiement-dialog.h ui_yeroth-erp-achats-detail-window.h ui_yeroth-erp-achats-window.h ui_yeroth-erp-charges-financieres-window.h ui_yeroth-erp-charges-financieres-detail-window.h ui_yeroth-erp-tableau-des-transactions-du-fournisseur-window.h ui_yeroth-erp-modifier-fournisseur-window.h ui_yeroth-erp-creer-fournisseur-window.h ui_yeroth-erp-fournisseur-details-window.h ui_yeroth-erp-DETAILS-DUN-GROUPE-DE-PAIE-hr-window.h ui_yeroth-erp-DETAILS-DUN-GROUPE-DEMPLOYES-hr-window.h ui_yeroth-erp-GROUPES-dun-employe-hr-window.h ui_yeroth-erp-creer-GROUPE-DE-PAIE-hr-window.h ui_yeroth-erp-creer-groupe-DEMPLOYES-hr-window.h ui_yeroth-erp-GROUPES-DEMPLOYES-hr-window.h ui_yeroth-erp-GROUPES-DE-PAIE-hr-window.h ui_yeroth-erp-fournisseurs-window.h ui_yeroth-erp-creer-un-programme-de-fidelite-clients-window.h ui_yeroth-erp-creer-compte-client-window.h ui_yeroth-erp-creer-groupe-de-clients-window.h ui_yeroth-erp-details-dun-groupe-de-clients-window.h ui_yeroth-erp-clients-detail-window.h ui_yeroth-erp-details-dun-programme-de-fidelite-clients-window.h ui_yeroth-erp-tableau-des-transactions-du-client-window.h ui_yeroth-erp-modifier-compte-client-window.h ui_yeroth-erp-modifier-groupe-de-clients-window.h ui_yeroth-erp-modifier-un-programme-de-fidelite-clients-window.h ui_yeroth-erp-payer-compte-client-window.h ui_yeroth-erp-programmes-de-fidelite-clients-window.h ui_yeroth-erp-groupes-de-clients-window.h ui_yeroth-erp-groupes-dun-client-window.h ui_yeroth-erp-clients-window.h ui_yeroth-erp-paiements-window.h ui_yeroth-erp-ventes-window.h ui_yeroth-erp-tableaux-de-bord-window.h ui_yeroth-erp-alertes-window.h ui_yeroth-erp-changer-utilisateur-dialog.h ui_yeroth-erp-admin-window.h ui_yeroth-erp-admin-search-form.h ui_yeroth-erp-admin-create-window.h ui_yeroth-erp-admin-lister-window.h ui_yeroth-erp-admin-detail-window.h ui_yeroth-erp-admin-modifier-window.h $(OBJECTS)  
...
all: Makefile bin/yeroth-erp-3-0
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) obj/yeroth-erp-3-0.gch/c obj/yeroth-erp-3-0.gch/c++
	-$(DEL_FILE) *~ core *.core
...
###### Precompiled headers
obj/yeroth-erp-3-0.gch/c: src/include/yeroth-erp-3-0-precompiled-header.hpp 
	@test -d obj/yeroth-erp-3-0.gch/ || mkdir -p obj/yeroth-erp-3-0.gch/
	$(CC) $(CFLAGS) $(INCPATH) -x c-header -c src/include/yeroth-erp-3-0-precompiled-header.hpp -o obj/yeroth-erp-3-0.gch/c

obj/yeroth-erp-3-0.gch/c++: src/include/yeroth-erp-3-0-precompiled-header.hpp 
	@test -d obj/yeroth-erp-3-0.gch/ || mkdir -p obj/yeroth-erp-3-0.gch/
	$(CXX) $(CXXFLAGS) $(INCPATH) -x c++-header -c src/include/yeroth-erp-3-0-precompiled-header.hpp -o obj/yeroth-erp-3-0.gch/c++
...
qrc_yeroth-erp-3-0.cpp: yeroth-erp-3-0.qrc \
		...
		yeroth-erp-3-0-images/yeroth-erp-3-0-font_size_UP.png \
		yeroth-erp-3-0-images/yeroth-erp-3-0-generate-client-royalty-card.png \
		yeroth-erp-3-0-images/folder-sort.svg.png \
		yeroth-erp-3-0-images/yeroth-erp-3-0-addition.png \
		yeroth-erp-3-0-images/yeroth-erp-3-0-page-derniere-image.png \
		yeroth-erp-3-0-images/yeroth-erp-3-0-save-icon.png \
		yeroth-erp-3-0-images/yeroth-erp-3.0-alert-good.png \
		yeroth-erp-3-0-images/yeroth-erp-3-0-printing-settings.png \
		yeroth-erp-3-0-images/yeroth-erp-3-0-image-password-eye.png \
		yeroth-erp-3-0-images/log-in.png \
		yeroth-erp-3-0-images/yeroth-erp-3-0-icon.png \
		yeroth-erp-3-0-images/yeroth-erp-3-0-page-precedente-image.png \
		yeroth-erp-3-0-images/log-out.png \
		yeroth-erp-3-0-images/yeroth-erp-3.0-select-database-table-column-icon.png \
		yeroth-erp-3-0-images/yeroth-erp-3-0-image-flag-red-eye.png \
		...
		yeroth-erp-3-0-images/yeroth-erp-3-0-administration-icon.png \
		...
		yeroth-erp-3-0-templates/EN_template-transactions-dun-client.tex \
		yeroth-erp-3-0-templates/FR_template_recu-petit.tex \
		yeroth-erp-3-0-templates/FR_ZERO_ventes.tex \
		yeroth-erp-3-0-templates/EN_template-historique-dun-stock.tex \
		yeroth-erp-3-0-templates/EN_template-transactions-dun-fournisseur.tex \
		yeroth-erp-3-0-templates/FR_template-liste-des-mouvements-de-stocks.tex \
		...
		yeroth-erp-3-0-templates/FR_template_GROUPES_DUN_CLIENT.tex \
		yeroth-erp-3-0-templates/EN_template_PAY_GROUP_LISTING.tex \
		yeroth-erp-3-0-templates/FR_template-lister-programmes-de-fidelite-clients.tex \
		yeroth-erp-3-0-templates/EN_template-lister-charges-financieres.tex \
		yeroth-erp-3-0-templates/FR_template_GROUPES_DUN_EMPLOYE.tex \
		yeroth-erp-3-0-templates/EN_template_facture-grand.tex \
		yeroth-erp-3-0-templates/FR_template-lister-programmes-de-fidelite-GROUPES-clients.tex \
		yeroth-erp-3-0-templates/FR_template-lister-charges-financieres.tex \
		yeroth-erp-3-0-templates/EN_template_EMPLOYEE_GROUP_LISTING.tex \
		...
		yeroth-erp-3-0-templates/FR_template-lister-alertes.tex \
		yeroth-erp-3-0-templates/EN_template_recu-petit.tex \
		...
		yeroth-erp-3-0-templates/EN_template-lister-programmes-de-fidelite-clients.tex \
		yeroth-erp-3-0-templates/EN_template-fiche-dun-client.tex \
		yeroth-erp-3-0-templates/FR_bar-diag.tex \
		yeroth-erp-3-0-templates/EN_template-sortie-des-stocks-grand.tex \
		yeroth-erp-3-0-templates/FR_template-bilan-comptable.tex \
		...
		yeroth-erp-3-0-templates/FR_template-fiche-dun-fournisseur.tex \
		yeroth-erp-3-0-templates/FR_template-transactions-dun-client.tex \
		...
		yeroth-erp-3-0-templates/EN_template-fiche-dun-fournisseur.tex \
		yeroth-erp-3-0-templates/FR_template_facture-grand.tex \
		yeroth-erp-3-0-templates/EN_template-comptabilite.tex \
		yeroth-erp-3-0-templates/EN_pie-chart.tex \
		yeroth-erp-3-0-templates/EN_template-lister-achats.tex \
		yeroth-erp-3-0-templates/FR_template-fiche-dun-client.tex \
		yeroth-erp-3-0-templates/EN_template-journal-des-paiements.tex \
		yeroth-erp-3-0-templates/EN_ZERO_ventes.tex \
		...
		yeroth-erp-3-0-templates/FR_YEROTH_LOYALTY_MEMBERSHIP_CARD_TEMPLATE.tex \
		yeroth-erp-3-0-templates/EN_template-lister-alertes.tex \
		yeroth-erp-3-0-templates/YEROTH-ERP-3D-BARDIAG-TEMPLATE.tex \
		yeroth-erp-3-0-templates/EN_bar-diag.tex \
		yeroth-erp-3-0-templates/FR_template-THREE_D_bardiag.tex \
		...
		yeroth-erp-3-0-sql/create_table_remises.sql \
		yeroth-erp-3-0-sql/create_table_typedoperations_financieres.sql \
		...
		yeroth-erp-3-0-sql/create_table_typedepaiement.sql \
		yeroth-erp-3-0-sql/create_table_roles.sql \
		yeroth-erp-3-0-sql/create_table_localisations.sql \
		yeroth-erp-3-0-sql/create_table_LIGNES_BUDGETAIRES.sql \
		yeroth-erp-3-0-sql/create_table_operations_comptables.sql \
		yeroth-erp-3-0-sql/create_table_credit_card_issuing_company.sql \
		yeroth-erp-3-0-sql/create_table_stocks_sorties.sql \
		yeroth-erp-3-0-sql/create_table_charges_financieres.sql \
...
compiler_uic_make_all: ui_yeroth-erp-main-window.h ui_yeroth-erp-recherche-conditionnelle-window.h ui_yeroth-erp-imprimer-dialog.h ui_yeroth-erp-comptabilite-window.h ui_yeroth-erp-sortir-window.h ui_yeroth-erp-entrer-window.h ui_yeroth-erp-mouvements_de_stocks-window.h ui_yeroth-erp-marchandises-window.h ui_yeroth-erp-modifier-window.h ui_yeroth-erp-historique-du-stock-window.h ui_yeroth-erp-stocks-window.h ui_yeroth-erp-sortir-liststocks-window.h ui_yeroth-erp-stock-detail-window.h ui_yeroth-erp-pointdevente-liststocks-window.h ui_yeroth-erp-pointdevente-window.h ui_yeroth-erp-pointdevente-methode-paiement-carte-credit-dialog.h ui_yeroth-erp-pointdevente-methode-paiement-comptant-entree-dialog.h ui_yeroth-erp-pointdevente-methode-paiement-dialog.h ui_yeroth-erp-achats-detail-window.h ui_yeroth-erp-achats-window.h ui_yeroth-erp-charges-financieres-window.h ui_yeroth-erp-charges-financieres-detail-window.h ui_yeroth-erp-tableau-des-transactions-du-fournisseur-window.h ui_yeroth-erp-modifier-fournisseur-window.h ui_yeroth-erp-creer-fournisseur-window.h ui_yeroth-erp-fournisseur-details-window.h ui_yeroth-erp-DETAILS-DUN-GROUPE-DE-PAIE-hr-window.h ui_yeroth-erp-DETAILS-DUN-GROUPE-DEMPLOYES-hr-window.h ui_yeroth-erp-GROUPES-dun-employe-hr-window.h ui_yeroth-erp-creer-GROUPE-DE-PAIE-hr-window.h ui_yeroth-erp-creer-groupe-DEMPLOYES-hr-window.h ui_yeroth-erp-GROUPES-DEMPLOYES-hr-window.h ui_yeroth-erp-GROUPES-DE-PAIE-hr-window.h ui_yeroth-erp-fournisseurs-window.h ui_yeroth-erp-creer-un-programme-de-fidelite-clients-window.h ui_yeroth-erp-creer-compte-client-window.h ui_yeroth-erp-creer-groupe-de-clients-window.h ui_yeroth-erp-details-dun-groupe-de-clients-window.h ui_yeroth-erp-clients-detail-window.h ui_yeroth-erp-details-dun-programme-de-fidelite-clients-window.h ui_yeroth-erp-tableau-des-transactions-du-client-window.h ui_yeroth-erp-modifier-compte-client-window.h ui_yeroth-erp-modifier-groupe-de-clients-window.h ui_yeroth-erp-modifier-un-programme-de-fidelite-clients-window.h ui_yeroth-erp-payer-compte-client-window.h ui_yeroth-erp-programmes-de-fidelite-clients-window.h ui_yeroth-erp-groupes-de-clients-window.h ui_yeroth-erp-groupes-dun-client-window.h ui_yeroth-erp-clients-window.h ui_yeroth-erp-paiements-window.h ui_yeroth-erp-ventes-window.h ui_yeroth-erp-tableaux-de-bord-window.h ui_yeroth-erp-alertes-window.h ui_yeroth-erp-changer-utilisateur-dialog.h ui_yeroth-erp-admin-window.h ui_yeroth-erp-admin-search-form.h ui_yeroth-erp-admin-create-window.h ui_yeroth-erp-admin-lister-window.h ui_yeroth-erp-admin-detail-window.h ui_yeroth-erp-admin-modifier-window.h
compiler_uic_clean:
	-$(DEL_FILE) ui_yeroth-erp-main-window.h ui_yeroth-erp-recherche-conditionnelle-window.h ui_yeroth-erp-imprimer-dialog.h ui_yeroth-erp-comptabilite-window.h ui_yeroth-erp-sortir-window.h ui_yeroth-erp-entrer-window.h ui_yeroth-erp-mouvements_de_stocks-window.h ui_yeroth-erp-marchandises-window.h ui_yeroth-erp-modifier-window.h ui_yeroth-erp-historique-du-stock-window.h ui_yeroth-erp-stocks-window.h ui_yeroth-erp-sortir-liststocks-window.h ui_yeroth-erp-stock-detail-window.h ui_yeroth-erp-pointdevente-liststocks-window.h ui_yeroth-erp-pointdevente-window.h ui_yeroth-erp-pointdevente-methode-paiement-carte-credit-dialog.h ui_yeroth-erp-pointdevente-methode-paiement-comptant-entree-dialog.h ui_yeroth-erp-pointdevente-methode-paiement-dialog.h ui_yeroth-erp-achats-detail-window.h ui_yeroth-erp-achats-window.h ui_yeroth-erp-charges-financieres-window.h ui_yeroth-erp-charges-financieres-detail-window.h ui_yeroth-erp-tableau-des-transactions-du-fournisseur-window.h ui_yeroth-erp-modifier-fournisseur-window.h ui_yeroth-erp-creer-fournisseur-window.h ui_yeroth-erp-fournisseur-details-window.h ui_yeroth-erp-DETAILS-DUN-GROUPE-DE-PAIE-hr-window.h ui_yeroth-erp-DETAILS-DUN-GROUPE-DEMPLOYES-hr-window.h ui_yeroth-erp-GROUPES-dun-employe-hr-window.h ui_yeroth-erp-creer-GROUPE-DE-PAIE-hr-window.h ui_yeroth-erp-creer-groupe-DEMPLOYES-hr-window.h ui_yeroth-erp-GROUPES-DEMPLOYES-hr-window.h ui_yeroth-erp-GROUPES-DE-PAIE-hr-window.h ui_yeroth-erp-fournisseurs-window.h ui_yeroth-erp-creer-un-programme-de-fidelite-clients-window.h ui_yeroth-erp-creer-compte-client-window.h ui_yeroth-erp-creer-groupe-de-clients-window.h ui_yeroth-erp-details-dun-groupe-de-clients-window.h ui_yeroth-erp-clients-detail-window.h ui_yeroth-erp-details-dun-programme-de-fidelite-clients-window.h ui_yeroth-erp-tableau-des-transactions-du-client-window.h ui_yeroth-erp-modifier-compte-client-window.h ui_yeroth-erp-modifier-groupe-de-clients-window.h ui_yeroth-erp-modifier-un-programme-de-fidelite-clients-window.h ui_yeroth-erp-payer-compte-client-window.h
	-$(DEL_FILE) ui_yeroth-erp-programmes-de-fidelite-clients-window.h ui_yeroth-erp-groupes-de-clients-window.h ui_yeroth-erp-groupes-dun-client-window.h ui_yeroth-erp-clients-window.h ui_yeroth-erp-paiements-window.h ui_yeroth-erp-ventes-window.h ui_yeroth-erp-tableaux-de-bord-window.h ui_yeroth-erp-alertes-window.h ui_yeroth-erp-changer-utilisateur-dialog.h ui_yeroth-erp-admin-window.h ui_yeroth-erp-admin-search-form.h ui_yeroth-erp-admin-create-window.h ui_yeroth-erp-admin-lister-window.h ui_yeroth-erp-admin-detail-window.h ui_yeroth-erp-admin-modifier-window.h
...
ui_yeroth-erp-recherche-conditionnelle-window.h: ui/yeroth-erp-recherche-conditionnelle-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-combo-box.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/yeroth-erp-recherche-conditionnelle-window.ui -o ui_yeroth-erp-recherche-conditionnelle-window.h

ui_yeroth-erp-imprimer-dialog.h: ui/yeroth-erp-imprimer-dialog.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/utils/yeroth-erp-utils.hpp \
		src/include/yeroth-erp-3-0-software.text-configuration.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/yeroth-erp-imprimer-dialog.ui -o ui_yeroth-erp-imprimer-dialog.h

ui_yeroth-erp-comptabilite-window.h: ui/yeroth-erp-comptabilite-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-datetime-edit.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/yeroth-erp-comptabilite-window.ui -o ui_yeroth-erp-comptabilite-window.h

ui_yeroth-erp-sortir-window.h: ui/stocks/yeroth-erp-sortir-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-combo-box.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/stocks/yeroth-erp-sortir-window.ui -o ui_yeroth-erp-sortir-window.h
...
ui_yeroth-erp-mouvements_de_stocks-window.h: ui/stocks/yeroth-erp-mouvements_de_stocks-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-combo-box.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/stocks/yeroth-erp-mouvements_de_stocks-window.ui -o ui_yeroth-erp-mouvements_de_stocks-window.h

ui_yeroth-erp-marchandises-window.h: ui/stocks/yeroth-erp-marchandises-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-combo-box.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/stocks/yeroth-erp-marchandises-window.ui -o ui_yeroth-erp-marchandises-window.h

ui_yeroth-erp-modifier-window.h: ui/stocks/yeroth-erp-modifier-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-datetime-edit.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/stocks/yeroth-erp-modifier-window.ui -o ui_yeroth-erp-modifier-window.h

ui_yeroth-erp-historique-du-stock-window.h: ui/stocks/yeroth-erp-historique-du-stock-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/table-view/yeroth-erp-stocks-table-view.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/stocks/yeroth-erp-historique-du-stock-window.ui -o ui_yeroth-erp-historique-du-stock-window.h

ui_yeroth-erp-stocks-window.h: ui/stocks/yeroth-erp-stocks-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-combo-box.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/stocks/yeroth-erp-stocks-window.ui -o ui_yeroth-erp-stocks-window.h

ui_yeroth-erp-sortir-liststocks-window.h: ui/stocks/yeroth-erp-sortir-liststocks-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/table-view/yeroth-erp-stocks-table-view.hpp \
		src/include/yeroth-erp-3-0-software.text-configuration.hpp \
		src/include/yeroth-erp-3-0-definition-special-qt5.7-macro.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/stocks/yeroth-erp-sortir-liststocks-window.ui -o ui_yeroth-erp-sortir-liststocks-window.h

ui_yeroth-erp-stock-detail-window.h: ui/stocks/yeroth-erp-stock-detail-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-datetime-edit.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/stocks/yeroth-erp-stock-detail-window.ui -o ui_yeroth-erp-stock-detail-window.h

ui_yeroth-erp-pointdevente-liststocks-window.h: ui/pos/yeroth-erp-pointdevente-liststocks-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/table-view/yeroth-erp-stocks-table-view.hpp \
		src/include/yeroth-erp-3-0-software.text-configuration.hpp \
		src/include/yeroth-erp-3-0-definition-special-qt5.7-macro.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/pos/yeroth-erp-pointdevente-liststocks-window.ui -o ui_yeroth-erp-pointdevente-liststocks-window.h

ui_yeroth-erp-pointdevente-window.h: ui/pos/yeroth-erp-pointdevente-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-datetime-edit.hpp \
		...
		src/utils/yeroth-erp-service-stock-marchandise-data.hpp \
		src/widgets/yeroth-erp-combo-box.hpp
	/usr/lib/qt5/bin/uic ui/pos/yeroth-erp-pointdevente-window.ui -o ui_yeroth-erp-pointdevente-window.h

ui_yeroth-erp-pointdevente-methode-paiement-carte-credit-dialog.h: ui/pos/yeroth-erp-pointdevente-methode-paiement-carte-credit-dialog.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-combo-box.hpp \
		src/widgets/yeroth-erp-push-button.hpp \
		...
		src/utils/windows/yeroth-erp-abstract-class-yerothsearch-window.hpp \
		src/widgets/yeroth-erp-line-edit.hpp
	/usr/lib/qt5/bin/uic ui/pos/yeroth-erp-pointdevente-methode-paiement-carte-credit-dialog.ui -o ui_yeroth-erp-pointdevente-methode-paiement-carte-credit-dialog.h

ui_yeroth-erp-pointdevente-methode-paiement-comptant-entree-dialog.h: ui/pos/yeroth-erp-pointdevente-methode-paiement-comptant-entree-dialog.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-push-button.hpp \
		src/utils/yeroth-erp-utils.hpp \
		...
		src/utils/windows/yeroth-erp-abstract-class-yerothsearch-window.hpp \
		src/widgets/yeroth-erp-line-edit.hpp
	/usr/lib/qt5/bin/uic ui/pos/yeroth-erp-pointdevente-methode-paiement-comptant-entree-dialog.ui -o ui_yeroth-erp-pointdevente-methode-paiement-comptant-entree-dialog.h

ui_yeroth-erp-pointdevente-methode-paiement-dialog.h: ui/pos/yeroth-erp-pointdevente-methode-paiement-dialog.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/include/yeroth-erp-3-0-software.text-configuration.hpp \
		src/include/yeroth-erp-3-0-definition-special-qt5.7-macro.hpp \
		...
		src/utils/windows/yeroth-erp-abstract-class-yerothsearch-window.hpp \
		src/widgets/yeroth-erp-line-edit.hpp
	/usr/lib/qt5/bin/uic ui/pos/yeroth-erp-pointdevente-methode-paiement-dialog.ui -o ui_yeroth-erp-pointdevente-methode-paiement-dialog.h

ui_yeroth-erp-achats-detail-window.h: ui/purchase/yeroth-erp-achats-detail-window.ui \
		/usr/lib/qt5/bin/uic \
		src/widgets/yeroth-erp-push-button.hpp \
		src/widgets/yeroth-erp-line-edit.hpp \
		src/widgets/yeroth-erp-datetime-edit.hpp \
		...
		src/include/yeroth-erp-3-0-definition-month.hpp \
		src/include/yeroth-erp-3-0-definition-colour-rgb.hpp
	/usr/lib/qt5/bin/uic ui/purchase/yeroth-erp-achats-detail-window.ui -o ui_yeroth-erp-achats-detail-window.h

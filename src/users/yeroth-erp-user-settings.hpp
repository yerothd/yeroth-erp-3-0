...
public:
    ...
    {
        return QString("%1_page_from").arg(QString("local_parameter_%1").
    ...
    inline QString GET_WINDOWS_PAGE_TO_KEY_TO_STORE(const QString &
                                                    a_window_object_name)
    {
        return QString("%1_page_to").arg(QString("local_parameter_%1").
                                         arg(a_window_object_name));
    }
    ...
    {
        return
                        QString("%1_usersql_table_row_count").arg(QString
                                                                  ("local_parameter_%1").arg
                                                                  (a_window_object_name));
    }
    ...
    {
        return
                        QString("%1_print_table_font_size").arg(QString
                                                                ("local_parameter_%1").arg
                                                                (a_window_object_name));
    }
    ...
    {
        return
                        QString("%1_print_table_row_count").arg(QString
                                                                ("local_parameter_%1").arg
                                                                (a_window_object_name));
    }
    ...
    enum RESULT_PRINTING_PARAMETER lire_les_parametres_locaux_QTABLEWIDGET(
    ...
    enum RESULT_PRINTING_PARAMETER lire_les_parametres_locaux(
    									const QString &user_local_personal_setting_full_file_path,
										YerothWindowsCommons *a_current_window_to_table_print_as_parameter = 0);
    ...
    bool enregistrer_les_parametres_locaux__QTABLEWIDGET(
    					const QString					&user_local_personal_setting_full_file_path,
    ...
    inline void PRINT_PARAMETERS_TO_STRING()
    {
        ...
        ("YerothERPUserSettings::PRINT_PARAMETERS_TO_STRING()",

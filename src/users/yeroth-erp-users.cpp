...
YerothPOSUser::YerothPOSUser(YerothERPWindows *allWindows):_role(YerothUtils::ROLE_INDEFINI),
    _write_read_user_setting_file_YEROTH_SEMAPHORE(0),
    _user_personal_settings(0), _allWindows(allWindows)
{
...
void
YerothPOSUser::read_user_personal_PRINTING_PARAMETER_settings
...
void
YerothPOSUser::read_user_personal_PRINTING_PARAMETER_settings_QTABLEWIDGET
(YerothWindowsCommons *a_current_window_to_table_print_as_parameter
 /* = 0 */)
{
    _write_read_user_setting_file_YEROTH_SEMAPHORE->acquire(1);
    ...
    if (0 != _user_personal_settings)
    {
        enum RESULT_PRINTING_PARAMETER
        resultat_lecture_des_parametres_locaux =
                        _user_personal_settings->lire_les_parametres_locaux_QTABLEWIDGET
                        (_user_setting_disk_saving_file_name_FROM_MD5_HEX_USER_ID,
                         a_current_window_to_table_print_as_parameter);
						...
						YerothWindowsCommons *a_current_window_to_table_print_as_parameter /* = 0 */)
{
    ...
    if (0 != _user_personal_settings)
    {
    	...
    	{
            _user_personal_settings->enregistrer_les_parametres_locaux__QTABLEWIDGET
            (_user_setting_disk_saving_file_name_FROM_MD5_HEX_USER_ID,
             a_current_window_to_table_print_as_parameter);
    	}
    }
...
void YerothPOSUser::create_user_personal_settings_file()
{
    ...
    if (0 != _user_personal_settings)
    {
        ...
        if (PRINTING_PRAMATER_WINDOW_NOT_YET_DEFINED ==
                resultat_lecture_des_parametres_locaux
                || PRINTING_PARAMETER_FILE_DOESNT_EXIT ==
                resultat_lecture_des_parametres_locaux)
        {
            _user_personal_settings->enregistrer_les_parametres_locaux
            (_user_setting_disk_saving_file_name_FROM_MD5_HEX_USER_ID,

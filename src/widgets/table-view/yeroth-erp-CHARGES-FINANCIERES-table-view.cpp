/*
 * yeroth-erp-CHARGES-FINANCIERES-table-view.cpp
 *
 *      Author: DR.-ING. DIPL.-INF. XAVIER NOUMBISSI NOUNDOU
 */


#include "yeroth-erp-CHARGES-FINANCIERES-table-view.hpp"
...
void YerothERP_CHARGES_FINANCIERES_TableView::
...
void YerothERP_CHARGES_FINANCIERES_TableView::selectionChanged(const QItemSelection &selected,
